...
#
# --------------------------------------------------------------------------------
# "THE BEER-WARE LICENSE V.2" :
# guelfoweb@gmail.com and Yukinoshita47 wrote this file. As long as you retain this notice you
# can do whatever you want with this stuff bu dont remove this license
# If you wanna Recode put the original copyright If we meet some day, and you think
# this stuff is worth it, you can buy me a beer in return Gianni 'guelfoweb' Amato
# Special thanks to Yukinoshita 47 And Garuda Security Hacker
# For Make This Project Going Up 
# --------------------------------------------------------------------------------
#
...
help_man(){
	echo -e ""
	echo -e "------------------------------------------------------------------------"
	echo -e "                      Garuda Security Hacker" 
        echo -e "               Wordpress Enumeration And Bruteforce (W.E.A.B)"
	echo -e "                     by guelfolweb and Yukinoshita47"
	echo -e "------------------------------------------------------------------------"
